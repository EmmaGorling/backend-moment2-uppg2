...
function writeData(workexps) {
    ...
    if (workexps.length > 0) // Loop trough and create articles
    ...
    else // Answer if there is no worexperiences
    workexpDiv.innerHTML = "Kunde inte hitta n\xe5gra tidigare arbeten.";
}
...
function toggleChangeForm() {
    const changeForm = document.getElementById("changeForm");
    if (changeForm.style.display === "block") changeForm.style.display = "none";
    else changeForm.style.display = "block";
}

},{}]},["j2YDk","1SICI"], "1SICI", "parcelRequire1242")
